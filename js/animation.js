...
//頂点を設定
normalgeometry.vertices[0] = new THREE.Vector3(1, 0, 0);
normalgeometry.vertices[1] = new THREE.Vector3(0, 1, 0);
normalgeometry.vertices[2] = new THREE.Vector3(0, 0, 1);
normalgeometry.vertices[3] = new THREE.Vector3(0, 0, 0);
//面を設定
...
*/
var planegeo = new THREE.PlaneGeometry(Math.sqrt(2), Math.sqrt(2));
//planegeo.translate(Math.sqrt(2) / 2, Math.sqrt(2) / 2);
...
var normal = new THREE.Mesh(planegeo, planemat);
normal.position.set(0, (Math.sqrt(2) * 3) / 8, Math.sqrt(6) / 8);
//normal.position.set(0, 0, Math.sqrt(2) / 2);
markerScene.add(normal);
object.push(normal); //no3
